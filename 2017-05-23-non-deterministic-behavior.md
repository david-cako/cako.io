...
I think it's fair to consider most developers'/engineers' behaviors obsessive, idiosyncratic, or otherwise neurotic.

Mental disorders are incredibly interesting to me, because I think that they represent extremes in such a tangible way.  It's like Bauhaus, or De Stijl, but for human behavior.  Obvious, concise, exaggerated.  I feel like psychological disorders are like a petri dish for understanding these darwinian extremes in behavior, one which may allow us to understand on a developmental basis what causes these behaviors in less extreme cases.

![](/content/images/2017/05/Screen-Shot-2017-05-23-at-09.57.25.png)
<sup>Neue Haas Grotesk, specimen from [fontbureau.org](http://www.fontbureau.com/nhg/)</sup>

Something of recent interest is the [*intense-world* theory of autism](http://journal.frontiersin.org/article/10.3389/fnhum.2010.00224/full).  In essence, it asserts that autism is primarily characterized by enhanced learning/memory, enhanced fear response (perhaps as result), enhanced focus (leading to fanatical hobbies), enhanced emotionality (leading to suppression), and in high functioning cases, enhanced intelligence.
...
There's actually research backing the notion that there is a maximum disparity in IQ where it becomes improbable/impossible for a leader/follower dynamic to exist between two individuals.  

No different, the brilliance of a great artist comes with a strong incidence of cluster-B personality disorders.

Whatever you call it, it amounts to a historical inability to reason with the default behaviors and dynamics that humans implicitly establish, and represents 20% of the population in varying degrees.


## Then why, Darwin?

"Intuition" and "openness" tends to be associated with varying degrees of social dysfunction.  Jung said it was a measure of femininity, but I tend to notice that women who you might classify as "NF"-type personalities also generally are more likely to tweet proudly about spending the Friday night with their dog and watching FOTM netflix show, and I certainly don't consider myself to be feminine.  I think where Jung was going, stripping the tinge of "men are default" chauvinism, was "social dysfunction" -- perhaps at the most primitive level, a decreased willingness to fulfill your reproductive responsibilities.  It seems reasonable to assume that this 20% of the population still exists for a reason.

I'm strongly of the belief that human behavior is no less darwinian than anything else.  Lets take a reductionist assumption that all humans are either hunters, gatherers, or caretakers.  Where does this leave the artists, scientists, scholars, strategists, etc.?  I struggle to believe that these roles, or at least the neurobiology that cultivates them, didn't exist pre-renaissance. 

What if it makes pure evolutionary sense for divergent thinkers to sidestep social dynamics and externalities?  Is there any predator that succeeds without exaggerating its one killer-feature in the most efficient ways possible?
